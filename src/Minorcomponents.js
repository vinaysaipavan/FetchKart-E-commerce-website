...
export function LOGO(){
    return(
        <img src="./LOGO.png" alt="Logo" className="md:w-[170px] sm:w-[150px] w-[140px]  object-contain h-[45px] md:h-[55px] sm:h-[50px] code112 cursor-pointer flex items-center justify-center"/>
    )
}
...
export function Footer(){
    return(
      ...
      <div className="bg-slate-600 flex-1 w-full flex justify-center items-center flex-col text-slate-200 py-4">
        ...
        <p><strong>Developed By:</strong> Vinay Sai Pavan Banduchode</p>
        <p><strong>Internship Company:</strong> MicroIT</p>
        <p><strong>Tech Stack:</strong> React.js,Tailwind CSS</p>
        <p className="flex items-center"><MdCopyright /><strong>&nbsp;2025 MicroIT.&nbsp;</strong> All rights Reserved.</p>
      </div>
    </footer>
    )
}